       ...
       <header>
           <div class="custom-message-list-header-left">
               <select id="community-activity-sorted-by">
                   ...
                   <#-- Added additional sorting methods to the post list -->
                   
                    <#-- Sorting by post time, from newest to oldest -->
                   <option value="postTime" <#if sorting == 'postTime'>selected</#if>>${text.format("theme-lib.community-activity.postTime")}</option>
                    <#-- Sorting by the lowest number of kudos -->
                   <option value="lowKudos" <#if sorting == 'lowKudos'>selected</#if>>${text.format("theme-lib.community-activity.lowKudos")}</option>
                   ...
                   <option value="unSolved" <#if sorting == 'unSolved'>selected</#if>>${text.format("theme-lib.community-activity.unSolved")}</option>
               </select>
